...
QT_MOC_LITERAL(1, 9, 8), // "hasDigit"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 1), // "s"
QT_MOC_LITERAL(4, 21, 5) // "print"

    },
    "TextEdit\0hasDigit\0\0s\0print"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->hasDigit((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 1: _t->print((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
